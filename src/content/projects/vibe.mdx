...
title: Vibe
date: 2025-08-11
image: /images/projects/vibe.jpg
summary: A Lovable clone built with Next.js.
---
...
6. **Open your browser**: Visit [http://localhost:3000](http://localhost:3000)
   to start building with Vibe!
...
- [Clerk](https://clerk.com) - Authentication, billing and user management
- [Inngest](https://inngest.com) - Durable functions and AI agent orchestration
- [shadcn/ui](https://ui.shadcn.com) - Beautiful component library

You can find the [source code](https://github.com/mihaicristianfarcas/Vibe.git)
on my Github.
